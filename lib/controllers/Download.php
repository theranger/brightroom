...
class Download extends Controller {
	...
	function get(Request $request): Response {
		...
		if ($this->fileSystem->getEntryType() != EntryType::FILE) return $response->render(ResponseCode::BAD_REQUEST);

		return $response->stream(ResponseCode::OK, $this->fileSystem->getFile());
	}
}
